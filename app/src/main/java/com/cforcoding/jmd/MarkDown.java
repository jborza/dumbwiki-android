...
import static com.cforcoding.text.TextUtils.empty;
import static com.cforcoding.text.TextUtils.find;
import static com.cforcoding.text.TextUtils.join;
import static com.cforcoding.text.TextUtils.matches;
import static com.cforcoding.text.TextUtils.repeat;
import static com.cforcoding.text.TextUtils.replace;
import static com.cforcoding.text.TextUtils.tokenize;
...
public class MarkDown {
    ...
    private static final String WHOLE_LIST_PATTERN = String.format("" +
            "(" +          // $1 = whole list
            "(" +          // $2 - list beginning 
            "[ ]{0,%d}" +  //0-3 leading spaces
            "(%s)" +       // $3 = type list item marker : [-+*] or [
            "[ \\t]+" +    //trailing spaces
            ")" +            //end of list beginning
            "(?s:.+?)" +    // list contains, repeatedly:
            "(" +          // $4
            "\\z" +            //end of input
            "|" +            //or
            "\\n" +        //2 or more newlines
            "(?=\\S)" +        //and another list item?
